...
Public Class ResultBudget01 ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
...
#Region "==========Association============"
    ...
    <Association("PlanBudgetDetail01-ResultBudget01")> _
    <Index(0)> _
    <VisibleInDetailView(False), VisibleInListView(False), VisibleInLookupListView(False)> _

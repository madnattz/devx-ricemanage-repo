...
Public Class DemoResultBudget02 ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
...
#Region "==========Association============"
    Dim _PlanBudget02 As DemoPlanBudgetDetail02
    ...
    Public Property PlanBudget02() As DemoPlanBudgetDetail02
        Get
            Return _PlanBudget02
        End Get
        Set(ByVal value As DemoPlanBudgetDetail02)
            SetPropertyValue(Of DemoPlanBudgetDetail02)("PlanBudget02", _PlanBudget02, value)
        End Set
    End Property
#End Region

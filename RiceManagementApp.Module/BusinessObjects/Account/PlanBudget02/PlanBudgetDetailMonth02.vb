...
Public Class PlanBudgetDetailMonth02 ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
...
#Region "==========Association============"
    ...
    <Association("PlanBudgetDetail02-PlanBudgetDetailMonth02s")> _
    <Index(0)> _

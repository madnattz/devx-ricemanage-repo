...
Public Class AccountGFMISDetailPVData ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    <Association("SubmitIncomeAndExpensesMonthReport-AccountGFMISDetailPVDatas")> _
    ...
    <RuleRequiredField(DefaultContexts.Save)> _
    <ImmediatePostData()> _
    Public Property AmountExpend() As Double
        Get

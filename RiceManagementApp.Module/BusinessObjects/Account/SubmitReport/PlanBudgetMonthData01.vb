...
Public Class PlanBudgetMonthData01 ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Dim fPlanBudgetData01 As PlanBudgetData01
    <Association("PlanBudgetData01-PlanBudgetMonthData01s")> _
    Public Property PlanBudgetData01() As PlanBudgetData01
        Get
            Return fPlanBudgetData01
        End Get
        Set(ByVal value As PlanBudgetData01)
            SetPropertyValue(Of PlanBudgetData01)("PlanBudgetData01", fPlanBudgetData01, value)
        End Set
    End Property

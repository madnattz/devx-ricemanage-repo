...
Public Class PlanTransferDataExpenses ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    <Association("SubmitPlanTransferReport-PlanTransferDataExpenses")> _
    ...
    Private _SettingExpensesOid As String
    <VisibleInDetailView(False), VisibleInListView(False)> _
    Public Property SettingExpensesOid() As String
        Get
            Return _SettingExpensesOid
        End Get
        Set(ByVal value As String)
            SetPropertyValue("SettingExpensesOid", _SettingExpensesOid, value)
        End Set
    End Property

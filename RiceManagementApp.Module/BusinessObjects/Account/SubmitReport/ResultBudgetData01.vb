...
Public Class ResultBudgetData01 ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    <Association("PlanBudgetData01-ResultBudgetData01s")> _

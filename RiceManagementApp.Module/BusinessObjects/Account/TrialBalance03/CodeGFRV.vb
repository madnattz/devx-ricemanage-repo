...
<DefaultClassOptions(), NavigationItem("ตั้งค่า"), XafDisplayName("ตั้งค่ารหัสรายรับGF"), DefaultProperty("GFID")> _
Public Class CodeGFRV ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).

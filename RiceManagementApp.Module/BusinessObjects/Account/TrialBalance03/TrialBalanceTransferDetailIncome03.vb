...
Public Class TrialBalanceTransferDetailIncome03 ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
...
#Region "==========Association============"
    ...
    <Association("TrialBalanceTransfer03-TrialBalanceTransferDetailIncome03s")> _
...
#End Region
    ...
    Private _CatalogueNo As SettingIncome
    <XafDisplayName("รหัส")> _
    <VisibleInDetailView(False), VisibleInListView(True)> _
    Public Property CatalogueNo() As SettingIncome
        Get
            Return _CatalogueNo
        End Get
    ...
    Public ReadOnly Property listIncome() As String
        Get
            If listIncome Is Nothing Then
                listIncome = CatalogueNo.listIncome
            End If
        End Get
    End Property

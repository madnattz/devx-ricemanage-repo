...
''' <summary>
''' ประเภทเงินทุน เช่น เงินทุนหมุนเวียน เงินงบประมาณ
''' </summary>
''' <remarks></remarks>
<DefaultClassOptions()> _
Public Class MoneyType ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Dim fMoneyTypeId As Integer
    <Size(2)> _
    Public Property MoneyTypeId() As Integer
        Get
            Return fMoneyTypeId
        End Get
        Set(ByVal value As Integer)
            SetPropertyValue(Of Integer)("MoneyTypeId", fMoneyTypeId, value)
        End Set
    End Property
    Dim fMoneyTypeName As String
    Public Property MoneyTypeName() As String
        Get
            Return fMoneyTypeName
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("MoneyTypeName", fMoneyTypeName, value)
        End Set
    End Property

...
Public Class OrganizationSection ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Dim fSectionId As String
    Public Property SectionId() As String
        Get
            Return fSectionId
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("SectionId", fSectionId, value)
        End Set
    End Property
    ...
    Public Property SectionName() As String
        ...
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("SectionName", fSectionName, value)
        End Set
    End Property

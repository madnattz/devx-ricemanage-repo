...
''' <summary>
''' คำนำหน้าชื่อ เช่น นาย นาง นางสาว และยศต่างๆ
''' </summary>
''' <remarks></remarks>
<DefaultClassOptions()> _
Public Class PrefixName ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Dim fFrefixName As String
    <Size(50)> _
    Public Property FrefixName() As String
        Get
            Return fFrefixName
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("FrefixName", fFrefixName, value)
        End Set
    End Property

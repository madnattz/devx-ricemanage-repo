...
Public Class QualityAuditStep ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Dim fStepNo As String
    Public Property StepNo() As String
        Get
            Return fStepNo
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("StepNo", fStepNo, value)
        End Set
    End Property

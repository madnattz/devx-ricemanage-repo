...
Public Class ReceiveType ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Public Property ReceiveID() As String
        ...
        Set(ByVal value As String)
            SetPropertyValue(Of String)("ReceiveID", fReceiveID, value)
        End Set
    End Property
    Dim fReceiveName As String
    Public Property ReceiveName() As String
        Get
            Return fReceiveName
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("ReceiveName", fReceiveName, value)
        End Set
    End Property

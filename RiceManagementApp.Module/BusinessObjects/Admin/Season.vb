...
''' <summary>
''' ฤดูการผลิต มีสองอย่าง  1=แล้ง 2=ฝน
''' </summary>
''' <remarks></remarks>
<DefaultClassOptions()> _
Public Class Season ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Public Property SeasonID() As Integer
        ...
        Set(ByVal value As Integer)
            SetPropertyValue(Of Integer)("SeasonID", fSeasonID, value)
        End Set
    End Property

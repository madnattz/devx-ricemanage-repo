...
''' <summary>
''' สถานะเมล็ดพันธุ์ ซื้อคืน ดี คัดออกใช้ประโยชน์ได้ คัดออกใช้ประโยชน์ไม่ได้
''' </summary>
''' <remarks></remarks>
<DefaultClassOptions()> _
Public Class SeedStatus ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Dim fSeedStatusID As Integer
    <Size(20)> _
    Public Property SeedStatusID() As Integer
        Get
            Return fSeedStatusID
        End Get
        Set(ByVal value As Integer)
            SetPropertyValue(Of Integer)("SeedStatusID", fSeedStatusID, value)
        End Set
    End Property
    Dim fSeedStatusName As String
    Public Property SeedStatusName() As String
        Get
            Return fSeedStatusName
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("SeedStatusName", fSeedStatusName, value)
        End Set
    End Property

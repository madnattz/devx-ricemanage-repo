...
Public Class AuditKeepPlanDetail ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    <XafDisplayName("แผนจัดเก็บ (ตัน)")> _
    ...
    <XafDisplayName("ผลการจัดเก็บ (ตัน)")> _
    Public ReadOnly Property ActualQuantity() As Double
        Get
            ...
            Try
                ...
                Dim crt As String = "ReceiveSeed.Status='Approve' and SeedStatus.SeedStatusName like '%ดี%' and ReceiveSeed.ReceiveDate >= ? and ReceiveSeed.ReceiveDate <= ? and SeedType=? and SeedClass=? and Season=? and SeedYear=?"

...
<XafDisplayName("ส่งรายงาน ขพ.5")> _
...
Public Class SubmitPlanKP5Report
    Inherits BaseObject
    ...
    Public Sub MarkAsComplete()
        If Not IsDeleted Then
            ...
            Try
                ...
                '//ตัวแปลของ ขพ.5 (Detail) (รายชื่อ และที่อยู่ เกษตรกร) ประเภท List
                ...
                For Each item As PlanFarmer In PlanFarmers
                    ...
                    objDetail.QuantityPerUnit = ConvertToInteger(item.EstimateResultPerArea)
                    objDetail.BuyQuantity = ConvertToInteger(item.MaxBuyQuantity)
                    objDetail.SeedPrice = ConvertToInteger(item.SeedPrice)

...
<RuleCriteria("PickMaterialDetailDetailCheckValue", DefaultContexts.Save, "[Quantity] <= [MaterialProduct.AvailableAmount]", "จำนวนการจ่าย ต้องน้อยกว่าหรือเท่ากับจำนวนคงคลัง")> _

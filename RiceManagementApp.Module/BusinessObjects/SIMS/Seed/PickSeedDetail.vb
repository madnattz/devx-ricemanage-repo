...
<RuleCriteria("PickSeedDetail.CheckValue", DefaultContexts.Save, "[Quantity] <= [AvailableProductQuantity]", "จำนวนการจ่าย ต้องน้อยกว่าหรือเท่ากับจำนวนคงคลัง")> _
Public Class PickSeedDetail ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    Dim fPickSeed As PickSeed
    <Association("PickSeedDetailReferencesPickSeed")> _
    Public Property PickSeed() As PickSeed
        Get
            Return fPickSeed
        End Get
        Set(ByVal value As PickSeed)
            SetPropertyValue(Of PickSeed)("PickSeed", fPickSeed, value)
        End Set
    End Property

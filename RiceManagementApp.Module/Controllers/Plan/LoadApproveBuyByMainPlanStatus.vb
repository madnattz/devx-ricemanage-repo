...
Partial Public Class LoadApproveBuyByMainPlanStatus
    Inherits ViewController
    Public Sub New()
        InitializeComponent()
        TargetObjectType = GetType(ApproveBuy)
    ...
    Protected Overrides Sub OnActivated()
        ...
        ApproveBuyStatusAction.Items.Clear()

        ApproveBuyStatusAction.Items.Add(item1)
        ApproveBuyStatusAction.Items.Add(item2)
        ApproveBuyStatusAction.Items.Add(item3)
        ApproveBuyStatusAction.SelectedIndex = 0

        Search(ApproveBuyStatusAction.SelectedItem.Data)
    ...
    Private Sub GrowPlanStatusAction_Execute(sender As Object, e As SingleChoiceActionExecuteEventArgs) Handles ApproveBuyStatusAction.Execute
    ...
    Public Sub Search(data As String)
        Try
            If data <> -1 Then
                ...
                If (TypeOf View Is ListView) And (View.ObjectTypeInfo.Type Is GetType(ApproveBuy)) Then

...
Partial Public Class LoadBuyPlanByMainPlanStatus
    Inherits ViewController
    Public Sub New()
        InitializeComponent()
        TargetObjectType = GetType(BuyPlan)
    ...
    Protected Overrides Sub OnActivated()
        ...
        BuyPlanStatusAction.Items.Clear()

        BuyPlanStatusAction.Items.Add(item1)
        BuyPlanStatusAction.Items.Add(item2)
        BuyPlanStatusAction.Items.Add(item3)
        BuyPlanStatusAction.SelectedIndex = 0

        Search(BuyPlanStatusAction.SelectedItem.Data)
    ...
    Private Sub PlanStatusAction_Execute(sender As Object, e As SingleChoiceActionExecuteEventArgs) Handles BuyPlanStatusAction.Execute
    ...
    Public Sub Search(data As String)
        Try
            If data <> -1 Then
                ...
                If (TypeOf View Is ListView) And (View.ObjectTypeInfo.Type Is GetType(BuyPlan)) Then

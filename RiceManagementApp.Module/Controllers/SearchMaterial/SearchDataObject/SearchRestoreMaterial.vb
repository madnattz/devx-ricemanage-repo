...
<NonPersistent> _
Public Class SearchRestoreMaterial
    Inherits BaseObject
    ...
    Dim fRestoreNo As String
    <XafDisplayName("เลขที่ส่งคืน")> _
    Public Property RestoreNo() As String
        Get
            Return fRestoreNo
        End Get
        Set(ByVal value As String)
            SetPropertyValue(Of String)("RestoreNo", fRestoreNo, value)
        End Set
    End Property

    Dim fStartDate As Date
    <XafDisplayName("วันที่ส่งคืน")> _
    ...
    <XafDisplayName("สถานะการส่งคืน")> _

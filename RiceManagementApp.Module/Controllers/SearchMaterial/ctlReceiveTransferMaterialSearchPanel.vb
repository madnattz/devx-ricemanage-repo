...
Partial Public Class ctlReceiveTransferMaterialSearchPanel
    Inherits ViewController
    Public Sub New()
        InitializeComponent()
        TargetObjectType = GetType(ReceiveTransferMaterial)
    ...
    Dim obj As SearchReceiveTransferMaterial
    Private Sub ActSearchReceiveSeed_CustomizePopupWindowParams(sender As Object, e As CustomizePopupWindowParamsEventArgs) Handles ActSearchReceiveTransferMaterial.CustomizePopupWindowParams
        objectSpaceInternal = Application.CreateObjectSpace()
        obj = objectSpaceInternal.CreateObject(Of SearchReceiveTransferMaterial)()
    ...
    Private Sub ActSearchReceiveSeed_Execute(sender As Object, e As PopupWindowShowActionExecuteEventArgs) Handles ActSearchReceiveTransferMaterial.Execute
        Dim crt As String = "[ReceiveTransferMaterialDetails][[Oid] IS NOT NULL"
        ...
        If obj.Status <> PublicEnum.SimsStatusSearch.None Then
            crt &= " and [ReceiveStatus]=" & obj.Status
        End If

        If (TypeOf View Is ListView) And (View.ObjectTypeInfo.Type Is GetType(ReceiveTransferMaterial)) Then

...
Partial Public Class ctlTransferMaterialSearchPanel
    Inherits ViewController
    Public Sub New()
        InitializeComponent()
        TargetObjectType = GetType(TransferMaterial)
    ...
    Dim obj As SearchTransferMaterial
    Private Sub ActSearchReceiveSeed_CustomizePopupWindowParams(sender As Object, e As CustomizePopupWindowParamsEventArgs) Handles ActSearchTransferMaterial.CustomizePopupWindowParams
        objectSpaceInternal = Application.CreateObjectSpace()
        obj = objectSpaceInternal.CreateObject(Of SearchTransferMaterial)()
    ...
    Private Sub ActSearchReceiveSeed_Execute(sender As Object, e As PopupWindowShowActionExecuteEventArgs) Handles ActSearchTransferMaterial.Execute
        Dim crt As String = "[TransferMaterialDetails][[Oid] IS NOT NULL"
        ...
        If obj.PickNo <> "" Then
            crt &= " and [TransferNo]='" & obj.PickNo & "'"
        End If
        If Not ConvertToDate(obj.StartDate).Equals(Date.MinValue) And _
            ConvertToDate(obj.EndDate).Equals(Date.MinValue) Then
            crt &= " and [TransferDate] >= '" & obj.StartDate.ToString("yyyy-M-Mdd HH:mm:ss", New System.Globalization.CultureInfo("en-US")) & "'"
        End If
        ...
        If (TypeOf View Is ListView) And (View.ObjectTypeInfo.Type Is GetType(TransferMaterial)) Then

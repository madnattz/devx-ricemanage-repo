...
<XafDisplayName("¤é¹ËÒ")> _
<ImageName("SearchIcon")> _
<NonPersistent> _
Public Class SearchTransferSeed ' Specify more UI options using a declarative approach (http://documentation.devexpress.com/#Xaf/CustomDocument2701).
    ...
    <ImmediatePostData()> _
    <XafDisplayName("Ê¶Ò¹ÐàÁÅç´¾Ñ¹¸Øì")> _
    ...
    <XafDisplayName("Ê¶Ò¹Ð¡ÒÃ¨èÒÂâÍ¹")> _

...
Partial Public Class ctlPickSeedSearchPanel
    Inherits ViewController
    Public Sub New()
        InitializeComponent()
        TargetObjectType = GetType(PickSeed)
    ...
    Dim obj As SearchPickSeed
    Private Sub ActSearchReceiveSeed_CustomizePopupWindowParams(sender As Object, e As CustomizePopupWindowParamsEventArgs) Handles ActSearchPickSeed.CustomizePopupWindowParams
        objectSpaceInternal = Application.CreateObjectSpace()
        obj = objectSpaceInternal.CreateObject(Of SearchPickSeed)()
    ...
    Private Sub ActSearchReceiveSeed_Execute(sender As Object, e As PopupWindowShowActionExecuteEventArgs) Handles ActSearchPickSeed.Execute
        Dim crt As String = "[PickSeedDetails][[Oid] IS NOT NULL"
        '[รายการการจ่ายเมล็ดพันธุ์][[ชื่อเมล็ดพันธุ์.พืช.ชื่อพืช] = 'ข้าว']
        ...
        If (TypeOf View Is ListView) And (View.ObjectTypeInfo.Type Is GetType(PickSeed)) Then

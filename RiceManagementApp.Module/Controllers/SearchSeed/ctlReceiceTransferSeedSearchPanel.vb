...
Partial Public Class ctlReceiceTransferSeedSearchPanel
    Inherits ViewController
    Public Sub New()
        InitializeComponent()
        TargetObjectType = GetType(ReceiveTransferSeed)
    ...
    Dim obj As SearchReceiveTransferSeed
    Private Sub ActSearchReceiveSeed_CustomizePopupWindowParams(sender As Object, e As CustomizePopupWindowParamsEventArgs) Handles ActSearchReceiveTransferSeed.CustomizePopupWindowParams
        objectSpaceInternal = Application.CreateObjectSpace()
        obj = objectSpaceInternal.CreateObject(Of SearchReceiveTransferSeed)()
    ...
    Private Sub ActSearchReceiveSeed_Execute(sender As Object, e As PopupWindowShowActionExecuteEventArgs) Handles ActSearchReceiveTransferSeed.Execute
        Dim crt As String = "[ReceiveTransferSeedDetails][[Oid] IS NOT NULL"
        ...
        If (TypeOf View Is ListView) And (View.ObjectTypeInfo.Type Is GetType(ReceiveTransferSeed)) Then

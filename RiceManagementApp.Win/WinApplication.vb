...
Partial Public Class RiceManagementAppWindowsFormsApplication
    ...
    End Sub
    Private Sub RiceManagementAppWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
        e.Updater.Update()
        e.Handled = True
#Else
        '===============================
        'ทำการ Update database.
        If Configuration.ConfigurationManager.AppSettings("IsUpdated").ToUpper = "TRUE" Then
            e.Updater.Update()
            e.Handled = True

            'Update status in App Config.
            ...
            config.AppSettings.Settings("IsUpdated").Value = "False"
            config.AppSettings.Settings("LastUpdated").Value = Now.ToString
...
#End If
    End Sub
    Private Shared Sub RiceManagementAppWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
